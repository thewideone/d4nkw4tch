...
// Scene defines
// 
#define SCENE1_MODEL_VERT_COUNT 8
#define SCENE1_MODEL_FACE_COUNT 12
#define SCENE1_MODEL_EDGE_COUNT 18
...
#define SCENE1_TRANSFORMED_VERT_COUNT 8
#define SCENE1_FACE_FLAG_COUNT 12
#define SCENE1_EDGE_FLAG_COUNT 18
